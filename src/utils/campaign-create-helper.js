export const helperTH = {
    ...
    campaignHeader: 'title ของ campaign',
    ...
    validateBoundaries: 'ตัวคั่น (*, /, $, ...)',    
    validateBoundariesLessErrMsg: 'msg ตอบกลับเมื่อข้อมูลไม่ครบ',    
    validateBoundariesOverErrMsg: 'msg ตอบกลับเมื่อข้อมูลมากไป',    
    validateMsgAfterEnd: 'msg ตอบกลับเมื่อหมดเวลา ',    
    validateMsgBeforeStart: 'msg ตอบกลับเมื่อเล่นก่อนเวลา',    
    validateMsgPausedService: 'msg ปิดชั่วคราว',    
}
